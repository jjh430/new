...
const foodMapping = {
    ...
    // 일식 (대표 5가지 추가 및 중복 제외)
    '초밥': '스시', '라멘': '라멘', '우동': '우동', 
    '돈카츠': '돈가스', '타코야키': '타코야키', '오코노미야끼': '오코노미야키',
    '규동': '규동', '샤브샤브': '샤부샤부', '카레라이스': '카레라이스',
    '가라아게': '가라아게', '텐동': '텐동',
    '스키야키': '스키야키', '히츠마부시': '장어덮밥', '오뎅': '오뎅', '야끼우동': '야끼우동', '야키소바': '야키소바',

    // 이탈리아 대표 음식 (대표 5가지 추가 및 중복 제외)
    '파스타': '카르보나라', '피자': '피자', '리조또': '리조토', '라자냐': '라자냐', '뇨끼': '뇨끼',
    '깔조네': '깔조네', '브루스케타': '브루스케타', '카프레제': '카프레제 샐러드', '티라미수': '티라미수',

    // 프랑스 대표 음식 (대표 5가지 추가)
    '에스카르고': '에스카르고', '라따뚜이': '라따뚜이', '코코뱅': '코코뱅', '부야베스': '부야베스', '어니언 스프': '프랑스 양파 스프',

    // 미국 대표 음식 (대표 5가지 추가 및 중복 제외)
    '햄버거': '햄버거', '스테이크': '스테이크', '샌드위치': '샌드위치', '클램 차우더': '클램 차우더', '버팔로 윙': '버펄로 윙',
    '맥앤치즈': '맥 앤 치즈', '바비큐 립': '바비큐 립', '애플파이': '애플파이',

    // 태국 대표 음식 (대표 5가지 추가 및 중복 제외)
    '쌀국수': '쌀국수', '팟타이': '팟타이', '똠얌꿍': '똠얌', '솜땀': '솜 땀', '그린 커리': '그린 커리',
    '마사만 커리': '마사만 커리', '똠카카이': '똠 카 까이', '망고 스티키 라이스': '망고 찹쌀밥',

    // 동남아/기타
    '반미': '반미', '나시고랭': '나시고랭', '커리': '카레',
    '케밥': '케밥', '타코': '타코', '부리토': '부리토',

    // 분식/간식
    '와플': '와플', '팬케이크': '팬케이크', 
    '핫도그': '핫도그 (음식)', // 미국식 핫도그 사진을 위해 명칭 구체화
    '붕어빵': '붕어빵', '호떡': '호떡', '튀김': '튀김'
};
